            ...
            >
              ...
              <ul className="list-disc list-outside ml-5 space-y-2">
                <li className="text-sm text-gray-700 dark:text-gray-300">
                  Built and maintained responsive, modern web applications using
                  current frontend technologies.
                </li>
                <li className="text-sm text-gray-700 dark:text-gray-300">
                  Translated Figma designs into pixel-perfect, responsive
                  interfaces, collaborating closely with product designers to
                  ensure design fidelity.
                </li>
                <li className="text-sm text-gray-700 dark:text-gray-300">
                  Delivered a fully functional dashboard for a banking
                  interface, providing users with a clean and intuitive
                  financial management experience.
                </li>
                <li className="text-sm text-gray-700 dark:text-gray-300">
                  Consumed REST APIs and collaborated seamlessly with backend
                  developers to ensure smooth data integration and
                  functionality.
                </li>
                <li className="text-sm text-gray-700 dark:text-gray-300">
