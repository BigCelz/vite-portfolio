...
>
  <h3 className="font-semibold mb-2 text-gray-800 dark:text-gray-100">
    Frontend Developer @ Confidential
  </h3>
  <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">February 2025 - Present</p>
  <ul className="list-disc list-outside ml-5 space-y-2">
    <li className="text-sm text-gray-700 dark:text-gray-300">
      Built and maintained responsive, modern web applications using current frontend technologies.
    </li>
    <li className="text-sm text-gray-700 dark:text-gray-300">
      Translated Figma designs into pixel-perfect, responsive interfaces, collaborating closely with product designers to ensure design fidelity.
    </li>
    <li className="text-sm text-gray-700 dark:text-gray-300">
      Delivered a fully functional dashboard for a banking interface, providing users with a clean and intuitive financial management experience.
    </li>
    <li className="text-sm text-gray-700 dark:text-gray-300">
      Consumed REST APIs and collaborated seamlessly with backend developers to ensure smooth data integration and functionality.
    </li>
    <li className="text-sm text-gray-700 dark:text-gray-300">
      Collaborated with cross-functional teams to deliver high-quality, scalable web solutions.
    </li>
  </ul>
</TabsContent>
